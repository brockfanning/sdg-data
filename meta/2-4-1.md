...
goal_meta_national_link: <p>{{ https://g205sdgs.github.io/sdg-indicators/public/MetaDe/{{ indicator.indicator | slugify }}.pdf }}</p>
goal_meta_national_link_text: <p>Nationale Metadaten {{ indicator.indicator | slugify }}</p>
